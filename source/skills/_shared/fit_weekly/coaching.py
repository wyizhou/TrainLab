...
def codex_contracts(
    ...
    *,
    runtimes: Mapping[str, codex_runtime.Runtime],
    ...
    for stage in ("plan", "summary"):
        ...
        if runtime.stage != stage or runtime.prompt_prefix != coaching_contract.prompt(
            stage
        ):
        ...
        def prepare(
            ...
            scope: str,
            current: str = stage,
            chosen: codex_runtime.Runtime = runtime,
            schema: dict[str, Any] = business,
            check: Any = input_check,
        ) -> model_job.Adapter:
            return codex_adapter.prepare(
                root,
                end,
                scope,
                payload,
                schema,
                runtime=chosen,
                capability_path=capability_paths[current],
