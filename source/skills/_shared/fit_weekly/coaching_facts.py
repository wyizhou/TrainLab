...
def build(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    for activity, session in pairs:
        ...
        if activity["parser_version"] == "fit-summary-3":
            # Keep the existing report contract and frozen FIT input intact.
            # Its text limitations carry the new time basis to report readers.
            methods = {
                k: methods[k]
                for k in (
                    "continuous_metrics",
