...
# Garmin's implementation is split across sibling modules that import this
# contract namespace with ``*``. Keep these shared runtime symbols explicit.
_SPLIT_MODULE_EXPORTS = (
    hmac,
    os,
    random,
    shutil,
...
# source_field_path).
CANONICAL_SAMPLE_METRICS: dict[
    str, dict[str, tuple[str, str | None, str | None, str, str]]
] = {
    "steps": {
        "steps": ("garmin.steps.count", "count", "count", "sensor_observed", "/steps"),
        "distanceMeters": (
            "garmin.steps.distance_m",
            "m",
            "m",
            "sensor_observed",
            "/distanceMeters",
...
DAILY_SCALAR_METRICS: dict[
    str, dict[str, tuple[str, str | None, str | None, str, str]]
] = {
    "user_summary": {
        "steps": ("garmin.daily.steps", "count", "count", "provider_derived", "/steps"),
        "restingHeartRate": (
            "garmin.daily.resting_heart_rate_bpm",
            "bpm",
            "bpm",
            "provider_derived",
            "/restingHeartRate",
    ...
    "intensity_minutes": {
        "moderateIntensityMinutes": (
            "garmin.daily.moderate_intensity_minutes",
            "min",
            "min",
            "provider_derived",
            "/moderateIntensityMinutes",
    ...
    "hrv": {
        "lastNightAvg": (
            "garmin.hrv.last_night_average_ms",
            "ms",
            "ms",
            "provider_derived",
        ...
        "lastNight5MinHigh": (
            "garmin.hrv.last_night_5_min_high_ms",
            "ms",
            "ms",
            "provider_derived",
    ...
    "heart_rates": {
        "minHeartRate": (
            "garmin.heart_rate.daily_min_bpm",
            "bpm",
            "bpm",
            "provider_derived",
            "/minHeartRate",
        ...
        "maxHeartRate": (
            "garmin.heart_rate.daily_max_bpm",
            "bpm",
            "bpm",
            "provider_derived",
            "/maxHeartRate",
        ...
        "lastSevenDaysAvgRestingHeartRate": (
            "garmin.heart_rate.resting_7d_average_bpm",
            "bpm",
            "bpm",
            "provider_derived",
            "/lastSevenDaysAvgRestingHeartRate",
        ...
        "dailyAverageHeartRate": (
            "garmin.heart_rate.daily_average_bpm",
            "bpm",
            "bpm",
            "derived_statistic",
            "/heartRateValues/*/1",
    ...
    "spo2": {
        "averageSpO2": (
            "garmin.spo2.daily_average_percent",
            "%",
            "%",
            "provider_derived",
            "/averageSpO2",
        ...
        "avgSleepSpO2": (
            "garmin.spo2.sleep_average_percent",
            "%",
            "%",
            "provider_derived",
            "/avgSleepSpO2",
        ...
        "lowestSpO2": (
            "garmin.spo2.daily_lowest_percent",
            "%",
            "%",
            "provider_derived",
            "/lowestSpO2",
        ...
        "lastSevenDaysAvgSpO2": (
            "garmin.spo2.seven_day_average_percent",
            "%",
            "%",
            "provider_derived",
            "/lastSevenDaysAvgSpO2",
...
PHYSIOLOGY_SCALAR_METRICS: dict[
    str, dict[str, tuple[str, str | None, str | None, str, str]]
] = {
    "blood_pressure": {
        "systolic": (
...
ADVANCED_PHYSIOLOGY_METRICS: dict[
    str, dict[str, tuple[str, str | None, str | None, str, str]]
] = {
    "training_readiness": {
        "score": (
    ...
    "training_status": {
        ...
        "acuteTrainingLoad": (
            "garmin.training_status.acute_load",
            "load",
            "load",
            "provider_derived",
            "/acuteTrainingLoad",
    ...
    "running_tolerance": {
        ...
        "weeklyMileage": (
            "garmin.running_tolerance.weekly_distance_m",
            "m",
            "m",
            "provider_derived",
            "/weeklyMileage",
    ...
    "menstrual_day": {
        ...
        "periodLength": (
            "garmin.menstrual.period_length_days",
            "day",
            "day",
            "provider_derived",
            "/periodLength",
        ...
        "predictedCycleLength": (
            "garmin.menstrual.predicted_cycle_length_days",
            "day",
            "day",
            "provider_derived",
            "/predictedCycleLength",
    ...
    "nutrition_food_log": {
        ...
        "protein": ("garmin.nutrition.protein_g", "g", "g", "user_entered", "/protein"),
        "carbohydrates": (
            "garmin.nutrition.carbohydrates_g",
            "g",
            "g",
            "user_entered",
            "/carbohydrates",
        ),
        "fat": ("garmin.nutrition.fat_g", "g", "g", "user_entered", "/fat"),
    },
    "nutrition_meals": {
        "calories": (
            "garmin.nutrition.calories_kcal",
...
ACTIVITY_ENRICHMENT_RESOURCES = frozenset(
    resource for resource, _role in ACTIVITY_ENRICHMENTS
)
...
ACCOUNT_RESOURCE_KINDS = frozenset(
    resource for resource, spec in RESOURCE_CATALOG.items() if spec.scope == "account"
)
    ...
    for family in _PROVIDER_CREDENTIAL_FAMILIES:
        ...
        for index in range(len(words) - width + 1):
            ...
            if not suffix or all(
                part in _PROVIDER_CREDENTIAL_VALUE_SUFFIXES for part in suffix
            ):
                return True
    ...
    while stack:
        ...
        if value_type is dict:
            ...
            if (
                ...
                or len(value) > PROVIDER_JSON_MAX_CONTAINER_ITEMS
            ):
                raise _invalid_provider_json()
...
_DURABLE_PROVIDER_ERROR_CODES = frozenset(
    {
        ...
        "account_project_failed",
        "invalid_fit",
        "activity_parse_or_project_failed",
        "activity_summary_project_failed",
        "activity_extra_project_failed",
        "identity_mismatch",
        "verified_identity_required",
        "unknown_device_reference",
        "activity_inventory_count_invalid",
        "activity_inventory_count_drift",
        "activity_inventory_page_invalid",
        "activity_inventory_page_size_mismatch",
        "activity_inventory_duplicate_ids",
        "activity_inventory_paging_loop",
        ...
        "unsupported_garmin_client_structure",
        "raw_object_corrupt",
        "raw_cleanup_claim_replaced",
        "raw_cleanup_temp_replaced",
        ...
        "fit_parse_failed",
        "fit_not_available_for_activity_format",
        "activity_original_missing",
        "activity_original_ambiguous",
        "activity_original_archive_failed",
        "activity_enrichment_invalid",
        "activity_enrichment_identity_mismatch",
        "activity_enrichment_binding_mismatch",
        "activity_chart_invalid",
        "activity_chart_empty",
        "activity_reconcile_failed",
        ...
        "coverage_error",
        "cursor_crosses_gap",
        "unmapped_field_signature",
        "activity_summary_missing",
        "offline_repair_failed",
        "capability_cooldown",
        "provider_entry_budget_exhausted",
        "wall_clock_budget_exhausted",
        "activity_budget_exhausted",
        "fit_download_budget_exhausted",
        "raw_object_budget_exhausted",
        "cached_token_refresh_forbidden",
        "cached_token_unusable",
        "token_store_mutation_forbidden",
    }
)
...
class RetryClassification:
    ...
    status: Literal[
        "retry", "deferred", "auth_required", "forbidden", "not_available", "failed"
    ]
    retryable: bool
    ...
    *,
    ...
    if status == 429:
        ...
        return RetryClassification(
            "deferred" if retry_after > inline_retry_after_max_seconds else "retry",
            True,
        )
...
IGNORED_RESOURCES = {
    ...
    "get_stats_and_body": "client_combination",
...
class GarminCollectionHost:
    """Typed collaboration surface shared by the Garmin mixins.

    The concrete collector keeps the historical MRO (repair, FIT, activity,
    health, base).  This small host contract makes the shared state and
    cross-mixin hooks visible to static analysis without changing that MRO or
    the public ``GarminCollectionTool`` API.
    """

    config: GarminConfig
    transport: GarminTransport | None
    repo: Any
    budget_guard: ProductionBudgetGuard | None
