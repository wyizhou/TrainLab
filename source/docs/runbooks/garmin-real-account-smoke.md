...
证据 JSON 只能含 [`garmin_smoke_evidence.schema.json`](../../src/resources/harness/schemas/garmin_smoke_evidence.schema.json)
...
```bash
python3.12 scripts/verify_garmin_smoke.py --evidence /secure/path/garmin-smoke-evidence.json
```
