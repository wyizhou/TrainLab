...
R0协作与继承基线已由独立验收、Main实际检查及macOS/Linux全量CI确认，d525a39已推送当前实验分支。R1总采集预算、旧记录只读和独立副本接线已通过本机3070项独立测试及Main实际验收，待分支交付/CI；两阶段业务和真实调用尚未开始，旧失败不改判。准确步骤和保护证据只见活动计划。
