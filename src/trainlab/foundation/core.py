...
TABLES: dict[str, str] = {
    ...
    "data_subjects": "id INTEGER PRIMARY KEY, subject_key TEXT NOT NULL UNIQUE, timezone TEXT NOT NULL DEFAULT 'Asia/Singapore', is_active INTEGER NOT NULL DEFAULT 1 CHECK(is_active IN (0,1)), created_at_utc TEXT NOT NULL",
