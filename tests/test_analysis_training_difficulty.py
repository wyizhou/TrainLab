...
from trainlab.analysis.training_difficulty import (
    race_goal_contract,
...
def test_contract_exposes_one_auditable_scale_and_all_decision_factors(
    ...
    assert contract["configuration_key"] == (
        "project_global.training_difficulty_level"
    )
...
def test_every_training_control_is_explicit_and_pace_anchored(
    ...
    difficulty, goals = training_control_contracts(value)
