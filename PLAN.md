...
| --- | --- | --- | --- | --- | --- |
| ADHOC-0035 | [completed] | 官方a313e63的README及完整项目角色适配；不保留旧.pi自定义 | H35-01～06；精确安装、实际接入、保护、独立及主验收与依赖PR #23已交付 | 用户完全替换.pi授权；基于未合并PR #22头07cc516 | [执行计划](exec-plans/completed/ADHOC-0035-agentsmd-role-adapter.md) |
...
- 最新交付（2026-09-21）：ADHOC-0035已完成同版七文件安装、三角色实际接入、最终两组合独立验证及主完整本地验收；主上下文由主直接核，不冒称子独立取证。15项最小增量已交付[PR #23](https://github.com/wyizhou/TrainLab/pull/23)，依赖未合并#22，未合并、不运行远端CI。执行计划已归档；等待用户确认合并或新需求，业务继续暂停。本分支未复制ADHOC-0033源码或整份业务计划，下方旧记录仅保留基准历史，不是继续旧任务的指令。
